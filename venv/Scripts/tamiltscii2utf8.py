#!c:\users\asus\pycharmprojects\questionanswergeneration\venv\scripts\python.exe
# -*- coding: utf-8 -*-
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(("tamiltscii2utf8 error - file %s could not be processed due to - %s"%(source_file,str(fileOrConvException))))
